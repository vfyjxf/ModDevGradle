...
public class LegacyForgeMetadataTransform extends LegacyMetadataTransform {
    ...
    public void execute(ComponentMetadataContext context) {
        var versionCapabilities = VersionCapabilitiesInternal.ofForgeVersion(context.getDetails().getId().getVersion());
        executeWithConfig(context, createPath(context, LegacyForgeArtifacts.userdevClassifier(versionCapabilities), "jar"));
    }
    ...
    public void adaptWithConfig(ComponentMetadataContext context, JsonObject config) {
        ...
        var versionCapabilities = VersionCapabilitiesInternal.ofForgeVersion(id.getVersion());

        var userdevJarName = LegacyForgeArtifacts.userdevJarName(id.getName(), id.getVersion(), versionCapabilities);
